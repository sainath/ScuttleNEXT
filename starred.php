...
$_SESSION['pagename']='starred';
$_SESSION['starredactive'] = '1';
...
if ($templatename == 'editbookmark.tpl') {
    ...
    $bookmarks =& $bookmarkservice->getBookmarksStarred($start, $perpage, $userid, $cat, $terms, getSortOrder());
...
//echo "</pre>";
    ...
    if ($user == $currentUsername) {
        $title = T_('Starred Bookmarks') . filter($catTitle);
    } else {
